  ...
  var pluginName = 'selectric',
      ...
      init = function(element, options) {
        var options = $.extend({
              ...
              arrowButtonMarkup: '<b class="sel-button">&#x25be;</b>',
        ...
        function _populate() {
          ...
          if ( optionsLength = $options.length ) {
            ...
            $options.each(function(i){
              ...
              _$li += '<li class="'+ label + (i == currValue ? selectStr : '') + (i == optionsLength - 1 ? ' last' : '') + (selectDisabled ? ' disabled' : '') + '">' + optionText + '</li>';              
        ...
        function _open(e) {
          ...
          else { _input.val('').is(':focus') || _input.focus(); }
